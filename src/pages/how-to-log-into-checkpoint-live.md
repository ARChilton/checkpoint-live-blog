...
Everyone staffing the event uses the same login details to access Checkpoint Live. For example the email above states that the username is: **exampleUser** and the password is: **0A0T9g**
...
## You have now logged in, what next...

Having logged in, you will be presented with a screen that looks like this:
